...
class PantallaGastos extends StatefulWidget {
  const PantallaGastos({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: ColoresMoni.fondoPrincipal,
        elevation: 0,
        title: const Text('Agregar Gasto', style: EstilosMoni.tituloMedio),
        centerTitle: true,
        leading: IconButton(
            ...
            Container(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  style: EstilosMoni.textoNormal,
                  items:
                      CategoriasMoni.gastos.map<DropdownMenuItem<String>>((
                        String value,
                      ) {
